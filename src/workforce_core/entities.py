...
@dataclass
class DadosFalha:
    """Dados de atendimento de falha (Incremento 6).

    Campos obrigatorios ao encerrar, conforme
    docs/27_ALINHAMENTO_OFICIAL_SGO_WORKFORCE_v1_2.md secao 3.5: nota,
    ativo, sintoma, causa, acao e observacao. Podem ser preenchidos
    progressivamente entre o inicio e o encerramento do atendimento (o
    horario final obrigatorio e o proprio `Atividade.fim`).

    `os_referencia` e campo recomendado (nao obrigatorio, secao 3.5) para
    a "OS relacionada". Usa ReferenciaOS (Incremento 13) desde o inicio -
